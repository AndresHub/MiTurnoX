...
class FrameCreacionUsuarios(ctk.CTkFrame):
    ...
    def actualizar_listado_atenciones(self, app):
        ...
        self.asignar_tipo_atn_usr(app)

    def asignar_tipo_atn_usr(self, app):
        ...
        match self.tipo:
            case "Atención Simple":
                ...
                self.frame_asignar_tipo_1.pack(fill = "x")
                self.tipo_1_status = True
                self.lista_elementos.append(self.frame_asignar_tipo_1)
                print(len(self.lista_elementos))
            case "Atención Múltiple 1-1":
                ...
                if self.cantidad_atenciones == 1:
                    ...
                    return
                self.frame_asignar_tipo_2 = ctk.CTkFrame(app.ventana_config_usuarios.main_frame_usuarios)
                ...
                if self.cantidad_atenciones == 2:
                    ...
                    self.frame_asignar_tipo_2_10.pack_forget()
                self.frame_asignar_tipo_2.pack(fill = "x")
            ...
            case "Atención Múltiple 2-1":
                ...
                self.frame_asignar_tipo_3.pack(fill = "x")
            ...
            case "Atención Rebalse":
                ...
                if self.cantidad_atenciones == 1:
                    CTkMessagebox(title= "Error, solo existe una atención", message= "Seleccionar 'Atención simple' o 'Atención Libre'")
                    return
                self.frame_asignar_tipo_4 = ctk.CTkFrame(app.ventana_config_usuarios.main_frame_usuarios)
                ...
                self.frame_asignar_tipo_4.pack(fill = "x")
            ...
            case "Atención Libre":
                ...
                self.frame_asignar_tipo_5.pack(fill = "x")
                self.tipo_5_status = True
                
    def mostrar_seleccion_tipo_atn(self, atn_num):
        if atn_num == 1:
            pass
        elif atn_num == 2:
            pass
