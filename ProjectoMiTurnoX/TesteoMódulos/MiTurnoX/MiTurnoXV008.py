...
class FrameCreacionUsuarios(ctk.CTkFrame):
    def __init__(self, master, app):
        ...
        self.boton_asignar_tipo = ctk.CTkButton(self.frame_tipo_atencion, text= "Asignar Tipo", command= self.asignar_tipo_atn_usr)
    ...
    def actualizar_listado_atenciones(self):
        conn = None
        try:
            params = config()
        ...
        match self.tipo:
            case "Atención Simple":
                ...
                if self.tipo_2_status == True:
                    self.frame_asignar_tipo_2.pack_forget()
                    self.tipo_2_status = False
                if self.tipo_3_status == True:
                    self.frame_asignar_tipo_3.pack_forget()
                    self.tipo_3_status = False
                if self.tipo_4_status == True:
                    self.frame_asignar_tipo_4.pack_forget()
                    self.tipo_4_status = False
                if self.tipo_5_status == True:
                    self.frame_asignar_tipo_5.pack_forget()
                    self.tipo_5_status = False
                self.frame_asignar_tipo_1 = ctk.CTkFrame(self.frame_creacion_usuarios)
                self.etiqueta_tipo_atencion_1 = ctk.CTkLabel(self.frame_asignar_tipo_1, text= "Atención :")
                self.etiqueta_tipo_atencion_1.pack(side = "left", padx = 5, pady = 5)
                self.listado_tipo_atencion_1 = ctk.CTkOptionMenu(self.frame_asignar_tipo_1, values= self.listado_atenciones)
                self.listado_tipo_atencion_1.pack(side = "left", padx = 5, pady = 5)
                self.boton_guardar_tipo_1 = ctk.CTkButton(self.frame_asignar_tipo_1, text= "Guardar")
                self.boton_guardar_tipo_1.pack(padx = 5, pady = 5)
                self.frame_asignar_tipo_1.pack()
            ...
            case "Atención Múltiple 1-1":
                ...
                if self.cantidad_atenciones == 1:
                    ...
                    return
                self.frame_asignar_tipo_2 = ctk.CTkFrame(self.frame_creacion_usuarios)
                self.frame_asignar_tipo_2_1 = ctk.CTkFrame(self.frame_asignar_tipo_2, height = 20)
                self.frame_asignar_tipo_2_1.pack(fill = "x", expand = 1, padx = 5, pady = 1)
                self.etiqueta_tipo_atencion_2_1 = ctk.CTkLabel(self.frame_asignar_tipo_2_1, text= "Atencion 1 :  ", height = 20)
                self.etiqueta_tipo_atencion_2_1.pack(side = "left", padx = 5, pady = 1)
                self.listado_tipo_atencion_2_1 = ctk.CTkOptionMenu(self.frame_asignar_tipo_2_1, values= self.listado_atenciones)
                self.listado_tipo_atencion_2_1.pack(side = "left", padx = 5, pady = 1)
                self.frame_asignar_tipo_2_2 = ctk.CTkFrame(self.frame_asignar_tipo_2, height = 20)
                self.frame_asignar_tipo_2_2.pack(fill = "x", expand = 1, padx = 5, pady = 1)
                self.etiqueta_tipo_atencion_2_2 = ctk.CTkLabel(self.frame_asignar_tipo_2_2, text= "Atencion 2 :  ", height = 20)
                self.etiqueta_tipo_atencion_2_2.pack(side = "left", padx = 5, pady = 1)
                self.listado_tipo_atencion_2_2 = ctk.CTkOptionMenu(self.frame_asignar_tipo_2_2, values= self.listado_atenciones)
                self.listado_tipo_atencion_2_2.pack(side = "left", padx = 5, pady = 1)
                self.frame_asignar_tipo_2_3 = ctk.CTkFrame(self.frame_asignar_tipo_2, height = 20)
                self.frame_asignar_tipo_2_3.pack(fill = "x", expand = 1, padx = 5, pady = 1)
                self.etiqueta_tipo_atencion_2_3 = ctk.CTkLabel(self.frame_asignar_tipo_2_3, text= "Atencion 3 :  ", height = 20)
                self.etiqueta_tipo_atencion_2_3.pack(side = "left", padx = 5, pady = 1)
                self.listado_tipo_atencion_2_3 = ctk.CTkOptionMenu(self.frame_asignar_tipo_2_3, values= self.listado_atenciones)
                self.listado_tipo_atencion_2_3.pack(side = "left", padx = 5, pady = 1)
                self.frame_asignar_tipo_2_4 = ctk.CTkFrame(self.frame_asignar_tipo_2, height = 20)
                self.frame_asignar_tipo_2_4.pack(fill = "x", expand = 1, padx = 5, pady = 1)
                self.etiqueta_tipo_atencion_2_4 = ctk.CTkLabel(self.frame_asignar_tipo_2_4, text= "Atencion 4 :  ", height = 20)
                self.etiqueta_tipo_atencion_2_4.pack(side = "left", padx = 5, pady = 1)
                self.listado_tipo_atencion_2_4 = ctk.CTkOptionMenu(self.frame_asignar_tipo_2_4, values= self.listado_atenciones)
                self.listado_tipo_atencion_2_4.pack(side = "left", padx = 5, pady = 1)
                self.frame_asignar_tipo_2_5 = ctk.CTkFrame(self.frame_asignar_tipo_2, height = 20)
                self.frame_asignar_tipo_2_5.pack(fill = "x", expand = 1, padx = 5, pady = 1)
                self.etiqueta_tipo_atencion_2_5 = ctk.CTkLabel(self.frame_asignar_tipo_2_5, text= "Atencion 5 :  ", height = 20)
                self.etiqueta_tipo_atencion_2_5.pack(side = "left", padx = 5, pady = 1)
                self.listado_tipo_atencion_2_5 = ctk.CTkOptionMenu(self.frame_asignar_tipo_2_5, values= self.listado_atenciones)
                self.listado_tipo_atencion_2_5.pack(side = "left", padx = 5, pady = 1)
                self.frame_asignar_tipo_2_6 = ctk.CTkFrame(self.frame_asignar_tipo_2, height = 20)
                self.frame_asignar_tipo_2_6.pack(fill = "x", expand = 1, padx = 5, pady = 1)
                self.etiqueta_tipo_atencion_2_6 = ctk.CTkLabel(self.frame_asignar_tipo_2_6, text= "Atencion 6 :  ", height = 20)
                self.etiqueta_tipo_atencion_2_6.pack(side = "left", padx = 5, pady = 1)
                self.listado_tipo_atencion_2_6 = ctk.CTkOptionMenu(self.frame_asignar_tipo_2_6, values= self.listado_atenciones)
                self.listado_tipo_atencion_2_6.pack(side = "left", padx = 5, pady = 1)
                self.frame_asignar_tipo_2_7 = ctk.CTkFrame(self.frame_asignar_tipo_2, height = 20)
                self.frame_asignar_tipo_2_7.pack(fill = "x", expand = 1, padx = 5, pady = 1)
                self.etiqueta_tipo_atencion_2_7 = ctk.CTkLabel(self.frame_asignar_tipo_2_7, text= "Atencion 7 :  ", height = 20)
                self.etiqueta_tipo_atencion_2_7.pack(side = "left", padx = 5, pady = 1)
                self.listado_tipo_atencion_2_7 = ctk.CTkOptionMenu(self.frame_asignar_tipo_2_7, values= self.listado_atenciones)
                self.listado_tipo_atencion_2_7.pack(side = "left", padx = 5, pady = 1)
                self.frame_asignar_tipo_2_8 = ctk.CTkFrame(self.frame_asignar_tipo_2, height = 20)
                self.frame_asignar_tipo_2_8.pack(fill = "x", expand = 1, padx = 5, pady = 1)
                self.etiqueta_tipo_atencion_2_8 = ctk.CTkLabel(self.frame_asignar_tipo_2_8, text= "Atencion 8 :  ", height = 20)
                self.etiqueta_tipo_atencion_2_8.pack(side = "left", padx = 5, pady = 1)
                self.listado_tipo_atencion_2_8 = ctk.CTkOptionMenu(self.frame_asignar_tipo_2_8, values= self.listado_atenciones)
                self.listado_tipo_atencion_2_8.pack(side = "left", padx = 5, pady = 1)
                self.frame_asignar_tipo_2_9 = ctk.CTkFrame(self.frame_asignar_tipo_2)
                self.frame_asignar_tipo_2_9.pack(fill = "x", expand = 1, padx = 5, pady = 1)
                self.etiqueta_tipo_atencion_2_9 = ctk.CTkLabel(self.frame_asignar_tipo_2_9, text= "Atencion 9 :  ", height = 20)
                self.etiqueta_tipo_atencion_2_9.pack(side = "left", padx = 5, pady = 1)
                self.listado_tipo_atencion_2_9 = ctk.CTkOptionMenu(self.frame_asignar_tipo_2_9, values= self.listado_atenciones)
                self.listado_tipo_atencion_2_9.pack(side = "left", padx = 5, pady = 1)
                self.frame_asignar_tipo_2_10 = ctk.CTkFrame(self.frame_asignar_tipo_2, height = 20)
                self.frame_asignar_tipo_2_10.pack(fill = "x", expand = 1, padx = 5, pady = 1)
                self.etiqueta_tipo_atencion_2_10 = ctk.CTkLabel(self.frame_asignar_tipo_2_10, text= "Atencion 10 :", height = 20)
                self.etiqueta_tipo_atencion_2_10.pack(side = "left", padx = 5, pady = 1)
                self.listado_tipo_atencion_2_10 = ctk.CTkOptionMenu(self.frame_asignar_tipo_2_10, values= self.listado_atenciones)
                self.listado_tipo_atencion_2_10.pack(side = "left", padx = 5, pady = 1)
                self.boton_guardar_tipo_2 = ctk.CTkButton(self.frame_asignar_tipo_2, text= "Guardar")
                self.boton_guardar_tipo_2.pack(padx = 5, pady = 5)
                if self.cantidad_atenciones == 2:
                ...
                elif self.cantidad_atenciones == 3:
                    self.frame_asignar_tipo_2_4.pack_forget()
                    self.frame_asignar_tipo_2_5.pack_forget()
                    self.frame_asignar_tipo_2_6.pack_forget()
                    self.frame_asignar_tipo_2_7.pack_forget()
                    ...
                    self.frame_asignar_tipo_2_9.pack_forget()
                    self.frame_asignar_tipo_2_10.pack_forget()
                elif self.cantidad_atenciones == 4:
                    self.frame_asignar_tipo_2_5.pack_forget()
                    self.frame_asignar_tipo_2_6.pack_forget()
                    self.frame_asignar_tipo_2_7.pack_forget()
                    self.frame_asignar_tipo_2_8.pack_forget()
                    self.frame_asignar_tipo_2_9.pack_forget()
                    self.frame_asignar_tipo_2_10.pack_forget()
                elif self.cantidad_atenciones == 5:
                    self.frame_asignar_tipo_2_6.pack_forget()
                    self.frame_asignar_tipo_2_7.pack_forget()
                    self.frame_asignar_tipo_2_8.pack_forget()
                    self.frame_asignar_tipo_2_9.pack_forget()
                    self.frame_asignar_tipo_2_10.pack_forget()
                elif self.cantidad_atenciones == 6:
                    self.frame_asignar_tipo_2_7.pack_forget()
                    self.frame_asignar_tipo_2_8.pack_forget()
                    self.frame_asignar_tipo_2_9.pack_forget()
                    self.frame_asignar_tipo_2_10.pack_forget()
                elif self.cantidad_atenciones == 7:
                    self.frame_asignar_tipo_2_8.pack_forget()
                    self.frame_asignar_tipo_2_9.pack_forget()
                    self.frame_asignar_tipo_2_10.pack_forget()
                elif self.cantidad_atenciones == 8:
                    self.frame_asignar_tipo_2_9.pack_forget()
                    self.frame_asignar_tipo_2_10.pack_forget()
                elif self.cantidad_atenciones == 9:
                    self.frame_asignar_tipo_2_10.pack_forget()
                self.frame_asignar_tipo_2.pack()
            ...
            case "Atención Múltiple 2-1":
                ...
                if self.tipo_5_status == True:
                    self.frame_asignar_tipo_5.pack_forget()
                    self.tipo_5_status = False
                self.frame_asignar_tipo_3 = ctk.CTkFrame(self.frame_creacion_usuarios)
                self.frame_asignar_tipo_3_1 = ctk.CTkFrame(self.frame_asignar_tipo_3)
                self.frame_asignar_tipo_3_1.pack(fill = "x", expand = 1, padx = 5, pady = 2)
                ...
                self.frame_asignar_tipo_3_2.pack(fill = "x", expand = 1, padx = 5, pady = 2)
                ...
                self.boton_guardar_tipo_3.pack(padx = 5, pady = 5)
                self.frame_asignar_tipo_3.pack()
            ...
            case "Atención Rebalse":
                ...
                if self.cantidad_atenciones == 1:
                    CTkMessagebox(title= "Error, solo existe una atención", message= "Seleccionar 'Atención simple' o 'Atención Libre'")
                    return
                self.frame_asignar_tipo_4 = ctk.CTkFrame(self.frame_creacion_usuarios)
                self.frame_asignar_tipo_4_1 = ctk.CTkFrame(self.frame_asignar_tipo_4)
                self.frame_asignar_tipo_4_1.pack(fill = "x", expand = 1, padx = 5, pady = 1)
                self.etiqueta_tipo_atencion_4_1 = ctk.CTkLabel(self.frame_asignar_tipo_4_1, text= "Atencion 1 :  ", height = 20)
                self.etiqueta_tipo_atencion_4_1.pack(side = "left", padx = 5, pady = 1)
                self.listado_tipo_atencion_4_1 = ctk.CTkOptionMenu(self.frame_asignar_tipo_4_1, values= self.listado_atenciones)
                self.listado_tipo_atencion_4_1.pack(side = "left", padx = 5, pady = 1)
                self.frame_asignar_tipo_4_2 = ctk.CTkFrame(self.frame_asignar_tipo_4)
                self.frame_asignar_tipo_4_2.pack(fill = "x", expand = 1, padx = 5, pady = 1)
                self.etiqueta_tipo_atencion_4_2 = ctk.CTkLabel(self.frame_asignar_tipo_4_2, text= "Atencion 2 :  ", height = 20)
                self.etiqueta_tipo_atencion_4_2.pack(side = "left", padx = 5, pady = 1)
                self.listado_tipo_atencion_4_2 = ctk.CTkOptionMenu(self.frame_asignar_tipo_4_2, values= self.listado_atenciones)
                self.listado_tipo_atencion_4_2.pack(side = "left", padx = 5, pady = 1)
                self.frame_asignar_tipo_4_3 = ctk.CTkFrame(self.frame_asignar_tipo_4)
                self.frame_asignar_tipo_4_3.pack(fill = "x", expand = 1, padx = 5, pady = 1)
                self.etiqueta_tipo_atencion_4_3 = ctk.CTkLabel(self.frame_asignar_tipo_4_3, text= "Atencion 3 :  ", height = 20)
                self.etiqueta_tipo_atencion_4_3.pack(side = "left", padx = 5, pady = 1)
                self.listado_tipo_atencion_4_3 = ctk.CTkOptionMenu(self.frame_asignar_tipo_4_3, values= self.listado_atenciones)
                self.listado_tipo_atencion_4_3.pack(side = "left", padx = 5, pady = 1)
                self.frame_asignar_tipo_4_4 = ctk.CTkFrame(self.frame_asignar_tipo_4)
                self.frame_asignar_tipo_4_4.pack(fill = "x", expand = 1, padx = 5, pady = 1)
                self.etiqueta_tipo_atencion_4_4 = ctk.CTkLabel(self.frame_asignar_tipo_4_4, text= "Atencion 4 :  ", height = 20)
                self.etiqueta_tipo_atencion_4_4.pack(side = "left", padx = 5, pady = 1)
                self.listado_tipo_atencion_4_4 = ctk.CTkOptionMenu(self.frame_asignar_tipo_4_4, values= self.listado_atenciones)
                self.listado_tipo_atencion_4_4.pack(side = "left", padx = 5, pady = 1)
                self.frame_asignar_tipo_4_5 = ctk.CTkFrame(self.frame_asignar_tipo_4)
                self.frame_asignar_tipo_4_5.pack(fill = "x", expand = 1, padx = 5, pady = 1)
                self.etiqueta_tipo_atencion_4_5 = ctk.CTkLabel(self.frame_asignar_tipo_4_5, text= "Atencion 5 :  ", height = 20)
                self.etiqueta_tipo_atencion_4_5.pack(side = "left", padx = 5, pady = 1)
                self.listado_tipo_atencion_4_5 = ctk.CTkOptionMenu(self.frame_asignar_tipo_4_5, values= self.listado_atenciones)
                self.listado_tipo_atencion_4_5.pack(side = "left", padx = 5, pady = 1)
                self.frame_asignar_tipo_4_6 = ctk.CTkFrame(self.frame_asignar_tipo_4)
                self.frame_asignar_tipo_4_6.pack(fill = "x", expand = 1, padx = 5, pady = 1)
                self.etiqueta_tipo_atencion_4_6 = ctk.CTkLabel(self.frame_asignar_tipo_4_6, text= "Atencion 6 :  ", height = 20)
                self.etiqueta_tipo_atencion_4_6.pack(side = "left", padx = 5, pady = 1)
                self.listado_tipo_atencion_4_6 = ctk.CTkOptionMenu(self.frame_asignar_tipo_4_6, values= self.listado_atenciones)
                self.listado_tipo_atencion_4_6.pack(side = "left", padx = 5, pady = 1)
                self.frame_asignar_tipo_4_7 = ctk.CTkFrame(self.frame_asignar_tipo_4)
                self.frame_asignar_tipo_4_7.pack(fill = "x", expand = 1, padx = 5, pady = 1)
                self.etiqueta_tipo_atencion_4_7 = ctk.CTkLabel(self.frame_asignar_tipo_4_7, text= "Atencion 7 :  ", height = 20)
                self.etiqueta_tipo_atencion_4_7.pack(side = "left", padx = 5, pady = 1)
                self.listado_tipo_atencion_4_7 = ctk.CTkOptionMenu(self.frame_asignar_tipo_4_7, values= self.listado_atenciones)
                self.listado_tipo_atencion_4_7.pack(side = "left", padx = 5, pady = 1)
                self.frame_asignar_tipo_4_8 = ctk.CTkFrame(self.frame_asignar_tipo_4)
                self.frame_asignar_tipo_4_8.pack(fill = "x", expand = 1, padx = 5, pady = 1)
                self.etiqueta_tipo_atencion_4_8 = ctk.CTkLabel(self.frame_asignar_tipo_4_8, text= "Atencion 8 :  ", height = 20)
                self.etiqueta_tipo_atencion_4_8.pack(side = "left", padx = 5, pady = 1)
                self.listado_tipo_atencion_4_8 = ctk.CTkOptionMenu(self.frame_asignar_tipo_4_8, values= self.listado_atenciones)
                self.listado_tipo_atencion_4_8.pack(side = "left", padx = 5, pady = 1)
                self.frame_asignar_tipo_4_9 = ctk.CTkFrame(self.frame_asignar_tipo_4)
                self.frame_asignar_tipo_4_9.pack(fill = "x", expand = 1, padx = 5, pady = 1)
                self.etiqueta_tipo_atencion_4_9 = ctk.CTkLabel(self.frame_asignar_tipo_4_9, text= "Atencion 9 :  ", height = 20)
                self.etiqueta_tipo_atencion_4_9.pack(side = "left", padx = 5, pady = 1)
                self.listado_tipo_atencion_4_9 = ctk.CTkOptionMenu(self.frame_asignar_tipo_4_9, values= self.listado_atenciones)
                self.listado_tipo_atencion_4_9.pack(side = "left", padx = 5, pady = 1)
                self.frame_asignar_tipo_4_10 = ctk.CTkFrame(self.frame_asignar_tipo_4)
                self.frame_asignar_tipo_4_10.pack(fill = "x", expand = 1, padx = 5, pady = 1)
                self.etiqueta_tipo_atencion_4_10 = ctk.CTkLabel(self.frame_asignar_tipo_4_10, text= "Atencion 10 :", height = 20)
                self.etiqueta_tipo_atencion_4_10.pack(side = "left", padx = 5, pady = 1)
                self.listado_tipo_atencion_4_10 = ctk.CTkOptionMenu(self.frame_asignar_tipo_4_10, values= self.listado_atenciones)
                self.listado_tipo_atencion_4_10.pack(side = "left", padx = 5, pady = 1)
                self.boton_guardar_tipo_4 = ctk.CTkButton(self.frame_asignar_tipo_4, text= "Guardar")
                self.boton_guardar_tipo_4.pack(padx = 5, pady = 5)
                if self.cantidad_atenciones == 2:
                    ...
                    self.frame_asignar_tipo_4_10.pack_forget()
                self.frame_asignar_tipo_4.pack()
            ...
            case "Atención Libre":
                ...
                if self.tipo_1_status == True:
                    self.frame_asignar_tipo_1.pack_forget()
                    self.tipo_1_status = False
                self.frame_asignar_tipo_5 = ctk.CTkFrame(self.frame_creacion_usuarios)
                self.etiqueta_tipo_atencion_5 = ctk.CTkLabel(self.frame_asignar_tipo_5, text= "Llamado Libre Asignado.")
                ...
                self.frame_asignar_tipo_5.pack()
